    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
      ...
      <div class="lg:col-span-1">
        ...
        <div class="flex space-x-4">
          <a
            href="#"
            class="text-gray-400 hover:text-primary-400 transition-all duration-300 hover:scale-110 transform hover:animate-bounce-gentle"
          >
      ...
      <!-- More Solutions -->
      <div>
        <h4 class="text-lg font-semibold mb-4">More Solutions</h4>
        <ul class="space-y-2">
          <li>
            <a
              href="#fixed-assets"
